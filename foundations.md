...
This chapter also describs that challenges that shape data science. As a tool, data can be misleading. Data creates specific illusions that you must be able to recognize and avoid as you do data science.
